...
from .models import db, User, Address, FavoriteUser, FavoriteListings, Reviews, Listings, Album, Books, BookCategories, Categories, Transactions
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(BookCategories, db.session))
