		...
		<div className="top-main">
			...
			<section className="home_Home__hero__dKSyR d-flex flex-column">
				<h1 className="hero_Hero__title__RoscS d-flex flex-column align-items-center justify-content-center text-center">
					<strong className="hero_Hero__title--bold__tlxm8">Compra y vende libros de segunda mano en Readeeks</strong>
				...
				<form name="searchbox" className="w-100 d-flex searchbox-form_SearchBox__form__dJdo_ searcher-home">
					...
					<button className="btn button_Button__4SB6a button_Button--submit__fDE0v align-items-center button-searcher-home" type="submit">Buscar</button>
		  ...
		  {/* realizar map para que salgan en main los articulos mas visitados, y el filter si le damos a cualquier categoria, solo salgan libros de esa categoria */}
			</div>
			</main>
		</div>
	);
